...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border border-none rounded-w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full pt-2 px-4 border border-gray-200 rounded' placeholder='Write about doctor' row={5} required />
        </div>
